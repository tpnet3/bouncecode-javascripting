[&EXEC]: # (touch if-statement.js && javascripting select if_statement && bouncecode editor-reset && bouncecode editor-open if-statement.js)
[&RUN]: # (node if-statement.js)
[&TEST]: # (javascripting select if_statement && javascripting run if-statement.js && javascripting verify if-statement.js)
