[&EXEC]: # (touch looping-through-arrays.js && javascripting select looping_through_arrays && bouncecode editor-reset && bouncecode editor-open looping-through-arrays.js)
