[&EXEC]: # (touch accessing-array-values.js && javascripting select accessing_array_values && bouncecode editor-reset && bouncecode editor-open accessing-array-values.js)
